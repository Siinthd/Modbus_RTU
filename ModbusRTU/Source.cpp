...
int main(void)
{
	...
	COMSTAT comstat;    //структура текущего состо€ни€ порта, в данной программе используетс€ дл€ определени€
						//количества прин€тых в порт байтов
	...
	hComm = CreateFile(pcComPort,
		...
		NULL,
		OPEN_EXISTING,
		0, //дл€ Modbus ставить FILE_FLAG_OVERLAPPED дл€ теста 0
		NULL);
